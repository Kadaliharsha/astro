...
compatibility_table = [
    ...
    {"planet_number": 4, "planet_name": "Rahu", "friends": [1, 2, 7], "neutrals": [5, 6, 9], "enemies": [3, 4, 8]},
    ...
    {"planet_number": 7, "planet_name": "Ketu", "friends": [1, 2], "neutrals": [4, 5, 7], "enemies": [3, 6, 8, 9]},
    {"planet_number": 8, "planet_name": "Saturn", "friends": [3, 5], "neutrals": [2, 6], "enemies": [1, 4, 7, 8, 9]},
...
class NumerologyApp:
    ...
    def process_owner_details(self):
        ...
        for planet in compatibility_table:
            ...
            if (planet_number in unique_numbers) and not any(num in planet["enemies"] for num in unique_numbers):
